...
const Icon = ({ name }) => /*#__PURE__*/React.createElement("i", { className: "icon material-icons" }, name);
    ...
    const links = this.props.headerLinks.map(link => {
      return /*#__PURE__*/(
        React.createElement(NavLink, {
          ...
          to: link.url,
          key: link.url,
          activeClassName: "active-link" }, /*#__PURE__*/
...
const CartIcon = props => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "cart-icon", onClick: props.onClick }, /*#__PURE__*/
    React.createElement(Icon, { name: "shopping_basket" }), /*#__PURE__*/
...
const CartItem = props => {
  return /*#__PURE__*/(
    React.createElement("div", { className: "product item" }, /*#__PURE__*/
    React.createElement(ProductImage, { product: props.data }), /*#__PURE__*/
    React.createElement("div", { className: "details" }, /*#__PURE__*/
    React.createElement("div", { className: "name bold" },
    props.data.name), /*#__PURE__*/

    React.createElement("div", { className: "price" },
    prettifyCurrency(props.data.price_currency),
    prettifyPrice(props.data.price))), /*#__PURE__*/
...
const CartEmpty = props => {
  return /*#__PURE__*/(
    ...
    React.createElement(Icon, { name: "shopping_cart" }), /*#__PURE__*/
    React.createElement("p", { className: "hint text" }, /*#__PURE__*/
...
class Cart extends React.Component {
  renderCartItems() {
    ...
    for (let itemKey in list) {
      if (list.hasOwnProperty(itemKey)) {
        items.push( /*#__PURE__*/React.createElement(CartItem, { key: itemKey, data: list[itemKey] }));
      }
    }
  ...
  renderActiveCart() {
    ...
    return /*#__PURE__*/(
      ...
      this.renderCartItems()), /*#__PURE__*/

      React.createElement("div", { className: "total" }, /*#__PURE__*/
      React.createElement("span", { className: "text bold" }, /*#__PURE__*/
      React.createElement(Text, { tag: 'header_total' })), /*#__PURE__*/

      React.createElement("span", { className: "amount bold" },
      countPriceOfItemsInCart(cart.list))), /*#__PURE__*/


      React.createElement("div", { className: "actions-wrapper" }, /*#__PURE__*/
      React.createElement("button", { className: "btn red wide" }, /*#__PURE__*/
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: "cart-topbar" }, /*#__PURE__*/
      React.createElement("a", { href: "javascript:;", className: "btn" }, /*#__PURE__*/
      React.createElement("i", { className: "icon material-icons" }, "close")), /*#__PURE__*/

      React.createElement("h3", { className: "cart-title" }, /*#__PURE__*/
      React.createElement("i", { className: "icon material-icons" }, "shopping_basket"), /*#__PURE__*/
...
class Header extends React.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement(HeaderNavigationContainer, null), /*#__PURE__*/
...
class Selector extends React.Component {
  render() {
    ...
    if (!this.props.disableDefault) {
      options.unshift( /*#__PURE__*/React.createElement("option", { key: 'default', value: "" }, /*#__PURE__*/React.createElement(Dict, { tag: this.props.placeholder || "placeholder_any" })));
    }


    return /*#__PURE__*/(
      React.createElement("div", null, /*#__PURE__*/
      React.createElement("label", { htmlFor: this.props.id }, /*#__PURE__*/
      React.createElement(Text, { tag: this.props.label })), /*#__PURE__*/
...
class Toggler extends React.Component {
  ...
  renderIcon(name) {
    return /*#__PURE__*/React.createElement(Icon, { name: name });
  }
  ...
  render() {
    ...
    return /*#__PURE__*/(
      ...
      this.renderCheckbox(), /*#__PURE__*/

      React.createElement("div", { className: "view" },
      this.renderLabel(), /*#__PURE__*/
...
class LanguageTabber extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement(Tabber, { default: this.props.ui.selectedLang, className: "lang", onSelect: this.handleSelect.bind(this) }, /*#__PURE__*/
      React.createElement(TabberOption, { value: "ua" }, /*#__PURE__*/
      React.createElement("span", { className: "flag-icon flag-icon-ua" })), /*#__PURE__*/

      React.createElement(TabberOption, { value: "eng" }, /*#__PURE__*/
...
class ColorPicker extends React.Component {
  ...
  renderLabel() {
    const { label } = this.state;
    return label ? /*#__PURE__*/React.createElement("label", { className: "label" }, /*#__PURE__*/React.createElement(Text, { tag: label })) : null;
  }
...
class SideA extends React.Component {
  ...
  renderResetButton() {
    ...
    return /*#__PURE__*/(
      React.createElement("button", {
        className: btbClass,
        onClick: this.handleResetButtonClick.bind(this) }, /*#__PURE__*/

      React.createElement(Icon, { name: "replay" }), /*#__PURE__*/
  ...
  render() {
    return /*#__PURE__*/(
      ...
      this.renderCategories(), /*#__PURE__*/
      React.createElement("br", null),
      this.renderBrands(), /*#__PURE__*/
      React.createElement("br", null),
      this.renderColors(), /*#__PURE__*/
      React.createElement("br", null),
      this.renderResetButton(), /*#__PURE__*/

      React.createElement("div", { className: "page-actions" }, /*#__PURE__*/
      React.createElement(NightModeTogglerContainer, null), /*#__PURE__*/
...
const ProductPricePlaceholder = () => {
  return /*#__PURE__*/(
    React.createElement("div", { className: "price placeholder" }, /*#__PURE__*/
...
class Product extends React.Component {
  ...
  renderProduct() {
    ...
    return /*#__PURE__*/(
      ...
      this.renderDiscount(), /*#__PURE__*/

      React.createElement(ProductImage, { product: product }), /*#__PURE__*/
      React.createElement("div", { className: "details" }, /*#__PURE__*/
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("li", { className: "product" }, /*#__PURE__*/
      React.createElement(NavLink, {
...
class ProductPlaceholder extends React.Component {
  ...
  render() {
    return /*#__PURE__*/(
      React.createElement("li", { className: "product placeholder" }, /*#__PURE__*/
...
class Products extends React.Component {
  renderItem(product, index) {
    return /*#__PURE__*/React.createElement(Product, { key: index, data: product });
  }

  renderPlaceholder(data, index) {
    return /*#__PURE__*/React.createElement(ProductPlaceholder, { key: index });
  }
  ...
  renderEmptyList() {
    ...
    return product.fetchIsFulfilled && product.list.length === 0 ? /*#__PURE__*/

    React.createElement("div", { className: "informer" }, /*#__PURE__*/
    React.createElement("h3", { className: "title" }, /*#__PURE__*/
    React.createElement(Text, { tag: "header_product_not_found" })), /*#__PURE__*/
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { className: "products-wrapper", "data-filter": product.appliedFilters.gender }, /*#__PURE__*/
      React.createElement("ul", { className: "products" },
      this.renderProductsList(),
      this.renderPlaceholderList(),
      this.renderEmptyList()), /*#__PURE__*/
...
class ProductsView extends React.Component {
  ...
  render() {
    ...
    join(" ");
    return /*#__PURE__*/(
      React.createElement("div", { id: "homepage", className: pageClass }, /*#__PURE__*/
      React.createElement(SideAContainer, null), /*#__PURE__*/
      React.createElement("div", { className: "content" }, /*#__PURE__*/
      React.createElement("h1", { className: "title" }, /*#__PURE__*/
      React.createElement(Text, { tag: this.props.pageData.title })), /*#__PURE__*/
...
const ProductDescriptionPlaceholder = props => {
  ...
  const placeholderLines = Array.from(Array(linesSize).keys()).map((l, i) => {
    return /*#__PURE__*/React.createElement("div", { className: "item text", key: i });
  });
...
const ProductDescription = ({ description = "" }) => {
  const descriptionHTML = description.split('\\n').map((item, key) => {
    return /*#__PURE__*/React.createElement("span", { key: key }, item, /*#__PURE__*/React.createElement("br", null));
  });
...
const ProductTitlePlaceholder = props => {
  return /*#__PURE__*/(
    React.createElement("div", { className: "title placeholder" }, /*#__PURE__*/
    React.createElement("div", { className: "item text" })));
...
const ProductBuyButtonPlaceholder = props => {
  return /*#__PURE__*/(
    React.createElement("div", { className: "button placeholder" }, /*#__PURE__*/
    React.createElement("div", { className: "item text" })));
...
class ProductDetails extends React.Component {
  ...
  renderPrice() {
    ...
    return this.props.product.details.fetchIsPending ? /*#__PURE__*/
    React.createElement(ProductPricePlaceholder, null) : /*#__PURE__*/
  ...
  renderDescription() {
    ...
    return details.fetchIsPending ? /*#__PURE__*/
    React.createElement(ProductDescriptionPlaceholder, { lines: 5 }) : /*#__PURE__*/
  ...
  renderTitle() {
    ...
    return details.fetchIsPending ? /*#__PURE__*/
    React.createElement(ProductTitlePlaceholder, null) : /*#__PURE__*/
  ...
  renderButton() {
    ...
    return details.fetchIsPending ? /*#__PURE__*/
    React.createElement(ProductBuyButtonPlaceholder, null) : /*#__PURE__*/

    React.createElement("button", {
      className: "btn red",
      onClick: this.handleButtonClick.bind(this) }, /*#__PURE__*/
  ...
  renderGender() {
    ...
    React.createElement("div", { className: "gender placeholder" }, /*#__PURE__*/
    React.createElement("span", { className: "item text" })) : /*#__PURE__*/


    React.createElement("span", { className: "gender" }, /*#__PURE__*/
  ...
  render() {
    ...
    return /*#__PURE__*/(
      React.createElement("div", { id: "details", className: pageClass }, /*#__PURE__*/

      React.createElement(SideAContainer, null), /*#__PURE__*/

      React.createElement("div", { className: "content" }, /*#__PURE__*/
      React.createElement("div", { className: "media" }, /*#__PURE__*/
      React.createElement(ProductImage, { product: productData })), /*#__PURE__*/


      React.createElement("div", { className: "details" }, /*#__PURE__*/
      React.createElement("div", { className: "title-wrapper" },
      this.renderTitle()), /*#__PURE__*/


      React.createElement("div", { className: "gender-wrapper" },
      this.renderGender()), /*#__PURE__*/


      React.createElement("div", { className: "price-wrapper" },
      this.renderPrice()), /*#__PURE__*/


      React.createElement("div", { className: "description-wrapper" }, /*#__PURE__*/
      React.createElement("div", { className: "subtitle" }, /*#__PURE__*/
      React.createElement("span", { className: "text bold" }, /*#__PURE__*/
      React.createElement(Text, { tag: "header_description" }))),


      this.renderDescription()), /*#__PURE__*/
  ...
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement(Route, {
        ...
        render:
        () => {
          return /*#__PURE__*/React.createElement(HomepageContainer, null);
        } }), /*#__PURE__*/
      ...
      React.createElement(Route, {
        ...
        render:
        () => {
          return /*#__PURE__*/React.createElement(WomenPageContainer, null);
        } }), /*#__PURE__*/
      ...
      React.createElement(Route, {
        ...
        render:
        () => {
          return /*#__PURE__*/React.createElement(MenPageContainer, null);
        } }), /*#__PURE__*/
      ...
      React.createElement(Route, {
        ...
        data => {
          ...
          return /*#__PURE__*/React.createElement(ProductDetailsContainer, { openedURL: openedURL });
        } }), /*#__PURE__*/
...
class App extends React.Component {
  render() {
    ...
    return /*#__PURE__*/(
      ...
      React.createElement("div", { className: appClassName }, /*#__PURE__*/
      React.createElement(HeaderContainer, null), /*#__PURE__*/
